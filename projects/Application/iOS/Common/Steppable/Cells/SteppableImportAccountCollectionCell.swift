//
//  SteppableImportAccountCollectionCell.swift
//  iOS
//
...
class SteppableImportAccountCollectionCell: UICollectionViewCell {
    ...
    private lazy var inputTextView = BorderedTextView(caption: "AccountAddingImportTitleCaption".asLocalizedKey).with({
...
extension SteppableImportAccountCollectionCell: UITextViewDelegate {
